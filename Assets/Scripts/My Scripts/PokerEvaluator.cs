...
public class PokerEvaluator : MonoBehaviour
{
    ...
    public void CallForRevealAction()
    {
        ...
        GameplayManager.GetInstance().SetGameState(GameState.RevealingChamberCards);

    }
    public void CheckHand(Chamber chamber)
    {
        // Combine the board cards and the chamber's cards
        var allCards = new List<Card>(cardManager.cardsOnBoard);
    ...
    {
        var cardsOnBoard = cardManager.cardsOnBoard;
        winningChamber = null;
